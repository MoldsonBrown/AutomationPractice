...
public class CheckoutFlowPage extends PageBaseStore {

    public CheckoutFlowPage(RemoteWebDriver driver) {
        super(driver);
        this.url = "";
    }
    ...
    public void verifyH1Summary(){
        Assert.assertEquals(getWebElement(By.id(H1_CSS_SELECTOR)).getText(),"SHOPPING-CART SUMMARY");
    }

    public void verifyH1Shipping(){
        Assert.assertEquals(getWebElement(By.id(H1_CSS_SELECTOR)).getText(),"SHIPPING");
    }
